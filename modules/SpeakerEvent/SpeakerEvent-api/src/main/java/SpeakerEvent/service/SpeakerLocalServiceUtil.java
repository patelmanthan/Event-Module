 ...
 * {@link SpeakerEvent.service.impl.SpeakerLocalServiceImpl} and is the
 ...
 * @see SpeakerEvent.service.base.SpeakerLocalServiceBaseImpl
...
public class SpeakerLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link SpeakerEvent.service.impl.SpeakerLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static SpeakerEvent.model.Speaker addSpeaker(
		SpeakerEvent.model.Speaker speaker) {
		return getService().addSpeaker(speaker);
	}

	public static SpeakerEvent.model.Speaker addSpeaker(long eventId,
		long userId, java.lang.String firstName, java.lang.String lastName,
		java.lang.String email) {
		return getService()
				   .addSpeaker(eventId, userId, firstName, lastName, email);
	}
	...
	*/
	public static SpeakerEvent.model.Speaker createSpeaker(long speakerId) {
	...
	*/
	public static SpeakerEvent.model.Speaker deleteSpeaker(
		SpeakerEvent.model.Speaker speaker) {
	...
	*/
	public static SpeakerEvent.model.Speaker deleteSpeaker(long speakerId)
		throws com.liferay.portal.kernel.exception.PortalException {
		return getService().deleteSpeaker(speakerId);
	}

	public static SpeakerEvent.model.Speaker fetchSpeaker(long speakerId) {
		return getService().fetchSpeaker(speakerId);
	}

	public static SpeakerEvent.model.Speaker findBySpeakerId(long speakerId) {
	...
	* @throws PortalException if a speaker with the primary key could not be found
	*/
	public static SpeakerEvent.model.Speaker getSpeaker(long speakerId)
		throws com.liferay.portal.kernel.exception.PortalException {
	...
	*/
	public static SpeakerEvent.model.Speaker updateSpeaker(
		SpeakerEvent.model.Speaker speaker) {
	...
	*/
	public static java.util.List<SpeakerEvent.model.Speaker> getSpeakers(
		int start, int end) {
	...
	*/
	...
	private static ServiceTracker<SpeakerLocalService, SpeakerLocalService> _serviceTracker =
		ServiceTrackerFactory.open(SpeakerLocalService.class);
}